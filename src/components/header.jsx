export default function Header() {
  return (
    <header className="text-gray-600 fill-gray-600 body-font">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <div className="lg:w-2/5 inline-flex lg:justify-start ml-5 lg:ml-0">
          <button className="inline-flex items-center focus:outline-none hover:bg-indigo-200 rounded text-base py-1 px-1 mt-4 md:mt-0">
            <a
        ...
        <div className="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
          <button
            className="inline-flex items-center border-0 py-1 px-1 focus:outline-none rounded text-base mt-4 md:mt-0"
